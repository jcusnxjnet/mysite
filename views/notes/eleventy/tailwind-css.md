...
<h2>Installation (Tailwind CLI tool)</h2>

```html
npm install -D tailwindcss 
```

<h2>Create configuration file - tailwind.config.js</h2>

```html
npx tailwindcss init
```

<h2>Template paths configuration</h2>
...
<h2>Adding the Tailwind directives</h2>
...
<h2>Execute Tailwind CLI build process</h2>

```html
npx tailwindcss -i ./views/assets/css/tailwind.css -o ./dist/assets/css/style.css
```

<h2>Add Tailwind output file in base layout</h2>
...
<h2>Adjust scripts in package.json</h2>
